...
export default function Import() {
  ...
  return (
    <div className="flex flex-col overflow-y-auto min-h-[50vh] h-[150vh] overflow-hidden  font-trap-Regular py-10 px-2 sm:px-12 gap-10 sm:gap-10 text-[#004F57] scrollbar-thin scrollbar-thumb-[#004F57] scrollbar-track-[#e0e0e0]">
      <div className="flex flex-col w-[100%] color-[#004F57]">
        ...
        <p className=" text-[10px] md:text-[15px] lg:text-[20px] xl:text-[20px] font-[500] leading-[12px] md:leading-[25px] w-[100%] sm:w-[60%]">
      ...
      <div className="flex flex-col sm:flex-row justify-between p-0 lg:p-10">
        ...
        <CallToActionBtn
          ...
          titleClass={"font-[700] text-[20px] sm:text-[25px] xl:text-[32px] text-secondary pt-1"}
          btnClass={
            "bg-secondary flex justify-center items-center rounded-2xl w-[50px] sm:w-[55px] xl:w-[72px] h-[50px]  sm:h-[55px] xl:h-[72px] cursor-pointer hover:opacity-90"
          }
